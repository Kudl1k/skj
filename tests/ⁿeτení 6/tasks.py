...
class CounterManager:
    ...
    Úřad byl napaden hackery, kteří vyřadili z provozu systém na vyvolávání návštěvníků k přepážkám.
    Naimplementujte funkci CounterManager (správce přepážek), abyste pomohli udržet úřad v chodu.
